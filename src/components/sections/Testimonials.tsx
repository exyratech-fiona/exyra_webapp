...
const testimonials = [
  {
    ...
    text: "I joined with zero cloud experience, straight out of college. The DevOps batch was intense — we did real EKS setups and wrote actual Jenkins pipelines, not just watched videos. Cleared CKA and joined TCS Digital. The trainers are working engineers, not just instructors.",
  },
  {
    name: "Nithya R.",
    ...
    color: "#00bcd4",
    rating: 5,
    outcome: "₹8.5 LPA — first job",
    text: "I used my Exyra project — a RAG-based document search tool — as my final-year project AND showed it in the Zoho interview. They hired me on the spot. The LangChain + ChromaDB stuff we built is actually running somewhere now, which still feels surreal.",
  },
  {
    name: "Praveen M.",
    role: "Cloud Engineer",
    ...
    color: "#00e676",
    rating: 4,
    outcome: "AWS SAA cleared — 60 days",
    text: "Honestly the AWS program was tougher than I expected, which is a good thing. Cleared AWS Solutions Architect Associate about 60 days in. Some modules could use more practice time, but the Terraform labs and multi-account exercises are the real deal. Joined Infosys Cloud team.",
  },
  {
    name: "Divya K.",
    ...
    color: "#8b5cf6",
    rating: 5,
    outcome: "Internship → full-time offer",
    text: "Did the internship first, then the full DevOps programme. Built a Prometheus + Grafana monitoring stack that's actually being used by a client now. Cognizant picked me up after seeing the project demo. The mentors take personal interest, which you don't get at big institutes.",
  },
  {
    name: "Arun Babu",
    role: "AI Test Automation Eng.",
    company: "Wipro",
    avatar: "AB",
    color: "#1457d6",
    rating: 5,
    outcome: "Career switch — QA to AI",
    text: "I was doing manual QA for 3 years and felt stuck. Took Exyra's GenAI track on the side. Built an LLM-powered test case generator as my project. Wipro's AI team saw it on my GitHub and reached out. Package is significantly better than what I was making before.",
  },
  {
    name: "Swetha V.",
    role: "DevOps + Web Dev",
    ...
    color: "#00bcd4",
    rating: 5,
    outcome: "Project demo got me hired",
    text: "I did both the web dev and DevOps tracks. My final project was a Kubernetes-deployed React app with a full CI/CD pipeline. Showed it in my Freshworks interview — they were more interested in the live demo than my resume. Joined their platform team.",
  },
];
